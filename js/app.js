...
angular.module('ToDoApp', ['ui.bootstrap'])
    .config(function($httpProvider) {
        ...
        $httpProvider.defaults.headers.common['X-Parse-Application-Id'] = '3e38bx3dExHHAmwgN1tcFJPofiMmguaGHOuhBUUd';
        $httpProvider.defaults.headers.common['X-Parse-REST-API-Key'] = 'T2b929j2tHBmMWQUg6I64mR5HwUQJbfTLMmPzatY';
    })
...
$scope.inserting is connected to button.
...
module ui.bootstrap - other module that its based on

incrementVotes from index
 */